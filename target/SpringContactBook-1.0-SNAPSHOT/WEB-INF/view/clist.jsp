...
<html>
    <head>
        ...
        <title>Contact List - Contact Book</title>
        ...
        <table border="1" width="80%" align="center">
            ...
            <tr>
                <td height="350px">
                    ...
                    <c:if test="${param.act eq 'ed'}">
                        <p class="success">Contact Edit Successfully!</p> 
                    </c:if>
            ...
            <table width="100%">
                ...
                <form action="<s:url value="/user/bulk_cdelete"/>">  
                    <button>Delete Selected Record</button></br><br/>
                    <table align="center" border="1" cellpadding="3" width="100%">
                        ...
                        <c:forEach var="c" items="${contactList}" varStatus="st">
                           <tr>
                            ...
                            <td><a href="${url_edit}">Edit</a>|<a href="${url_del}">Delete</a>
                            </td>
                        </tr> 
                        </c:forEach>
                    </table>
